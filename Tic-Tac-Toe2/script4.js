...
const renderData = () => {
  ...
  main.innerHTML = (
    `<div class="board-row">
        <div class="board-col">${board[0]}</div>
        <div class="board-col">${board[1]}</div>
        <div class="board-col">${board[2]}</div>
      </div>
      <div class="board-row">
        <div class="board-col">${board[3]}</div>
        <div class="board-col">${board[4]}</div>
        <div class="board-col">${board[5]}</div>
      </div>
      <div class="board-row">
        <div class="board-col">${board[6]}</div>
        <div class="board-col">${board[7]}</div>
        <div class="board-col">${board[8]}</div>
      </div>`
  );
}
renderData();
